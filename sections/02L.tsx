  ...
  return (
    <div className={styles.container} ref={containerRef}>
      ...
      <div className={styles.bg} ref={bgRef}>
        ...
        <object type="image/svg+xml" data="sections/02/th/stats-1.svg" className={styles.stats} ref={stats1Ref}/>
        <object type="image/svg+xml" data="sections/02/th/stats-2.svg" className={styles.stats} ref={stats2Ref}/>
        <object type="image/svg+xml" data="sections/02/th/stats-3.svg" className={styles.stats} ref={stats3Ref}/>
      </div>
    </div>
  )
}

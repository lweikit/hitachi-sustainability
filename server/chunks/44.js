...
/* harmony export */   "i": () => (/* binding */ ScrollTrigger1)
/* harmony export */ });
...
(function(global, factory) {
  ...
  */ var _config = {
    ...
    }, _isArray = Array.isArray, _strictNumExp = /(?:-?\.?\d|\.)+/gi, _numExp = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, _numWithUnitExp = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _complexStringNumExp = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, _relExp = /[+-]=-?[.\d]+/, _delimitedValueExp = /[^,'"\[\]\s]+/gi, _unitExp = /[\d.+\-=]+(?:e[-+]\d*)*/i, _globalTimeline, _win, _coreInitted, _doc, _globals = {
    }, _installScope = {
        ...
        for(var p in toMerge){
            p !== "__proto__" && p !== "constructor" && p !== "prototype" && (base[p] = _isObject(toMerge[p]) ? _mergeDeep(base[p] || (base[p] = {
            }), toMerge[p]) : toMerge[p]);
        }
        return base;
        ...
        var prevRatio = tween.ratio, ratio = totalTime < 0 || !totalTime && (!tween._start && _parentPlayheadIsBeforeStart1(tween) && !(!tween._initted && _isFromOrFromStart(tween)) || (tween._ts < 0 || tween._dp._ts < 0) && !_isFromOrFromStart(tween)) ? 0 : 1, repeatDelay = tween._rDelay, tTime = 0, pt, iteration, prevIteration;
        ...
        if (!func) {
            ...
            if (isString) {
                ...
                il = l - 2;
                for(i1 = 1; i1 < l; i1++){
                    interpolators.push(interpolate(start[i1 - 1], start[i1]));
                }
                l--;
                ...
                start = _merge(_isArray(start) ? [] : {
                }, start);
            }
            if (!interpolators) {
                for(p1 in end){
                    _addPropTween.call(master, start, p1, "get", end[p1]);
                }
                func = function func(p) {
        ...
        var p1 = amplitude1 >= 1 ? amplitude1 : 1, p2 = (period1 || (type ? 0.3 : 0.45)) / (amplitude1 < 1 ? amplitude1 : 1), p3 = p2 / _2PI * (Math.asin(1 / p1) || 0), easeOut = function easeOut(p) {
        ...
        _proto2.add = function add(child, position) {
            ...
            if (!(child instanceof Animation1)) {
                ...
                if (_isFunction(child)) {
                    child = Tween1.delayedCall(0, child);
                } else {
                    return this;
                }
            }
    ...
    var _addComplexStringPropTween = function _addComplexStringPropTween(target, prop, start, end, setter, stringFilter, funcParam) {
        ...
        return plugin;
    }, _overwritingTween, _initTween1 = function _initTween(tween, time) {
            ...
            if (!dur) {
                ...
                if (this._repeat) {
                    ...
                    if (iteration !== prevIteration) {
                        timeline && this._yEase && _propagateYoyoEase1(timeline, isYoyo);
    ...
    var _gsap = {
        ...
        quickSetter: function quickSetter(target, property, unit) {
            ...
            })[property] || property, setter = Plugin ? function(value) {
                var p = new Plugin();
                _quickTween._pt = 0;
        ...
        registerEffect: function registerEffect(_ref3) {
            ...
            if (extendTimeline) {
                Timeline1.prototype[name] = function(targets, vars, position) {
        ...
        exportRoot: function exportRoot(vars, includeDelayedCalls) {
            ...
            while(child){
                next = child._next;
                if (includeDelayedCalls || !(!child._dur && child instanceof Tween1 && child.vars.onComplete === child._targets[0])) {
    ...
    var _win$1, _doc$1, _docElement, _pluginInitted, _tempDiv, _tempDivStyler, _recentSetterPlugin, _windowExists$1 = function _windowExists() {
        ...
        bounds && (bounds.width || bounds.height) || target.getBBox === _getBBoxHack1 || (bounds = _getBBoxHack1.call(target, true));
        ...
        var pt = new PropTween1(plugin._pt, target, property, 0, 1, onlySetAtEnd ? _renderNonTweeningValueOnlyAtEnd : _renderNonTweeningValue);
        plugin._pt = pt;
        pt.b = beginning;
        pt.e = end;
        ...
        if (_transformProps[property] && property !== "transform") {
            ...
            if (!value || value === "auto" || uncache || ~(value + "").indexOf("calc(")) {
                value = _specialProps[property] && _specialProps[property](target, property, unit) || _getComputedProperty1(target, property) || _getProperty(target, property) || (property === "opacity" ? 1 : 0);
            }
        }
        ...
        if (!start || start === "none") {
            ...
            if (s && s !== start) {
                ...
                start = _getComputedProperty1(target, "borderTopColor");
            }
        }
        var pt = new PropTween1(this._pt, target.style, prop, 0, 1, _renderComplexString), index = 0, matchIndex = 0, a, result, startValues, startNum, color, startValue, endValue, endNum, chunk, endUnit, startUnit, relative, endValues;
        pt.b = start;
        pt.e = end;
        start += "";
        end += "";
            ...
            while(result = _numWithUnitExp.exec(end)){
                ...
                if (endValue !== (startValue = startValues[matchIndex++] || "")) {
                    ...
                    if (startUnit !== endUnit) {
                        startNum = _convertToUnit1(target, prop, startValue, endUnit) || 0;
                    }
                    pt._pt = {
                        _next: pt._pt,
                        p: chunk || matchIndex === 1 ? chunk : ",",
        ...
        clearProps: function clearProps(plugin, target, property, endValue, tween) {
            if (tween.data !== "isFromStart") {
                var pt = plugin._pt = new PropTween1(plugin._pt, target, property, 0, 0, _renderClearProps);
                pt.u = endValue;
                pt.pr = -10;
                pt.tween = tween;
                plugin._props.push(property);
        ...
        return _round(parseFloat(start) + parseFloat(_convertToUnit1(target, "x", value + "px", unit))) + unit;
        ...
        plugin._pt = pt = new PropTween1(plugin._pt, target, property, startNum, change, _renderPropWithEnd);
        pt.e = finalValue;
        pt.u = "deg";
        plugin._props.push(property);
        return pt;
        ...
        for(p in _transformProps){
            ...
            if (startValue !== endValue && exclude.indexOf(p) < 0) {
                ...
                endNum = parseFloat(endValue);
                plugin._pt = new PropTween1(plugin._pt, endCache, p, startNum, endNum - startNum, _renderCSSProp);
                ...
                if (specialProp) {
                    ...
                    if (isTransformRelated) {
                        if (!transformPropTween) {
                            ...
                            transformPropTween = this._pt = new PropTween1(this._pt, style, _transformProp, 0, 1, cache.renderTransform, cache, 0, -1);
                            transformPropTween.dep = 1;
                        }
                        if (p === "scale") {
                            this._pt = new PropTween1(this._pt, cache, "scaleY", cache.scaleY, (relative ? relative * endNum : endNum - cache.scaleY) || 0);
                            props.push("scaleY", p);
                            p += "X";
                    ...
                    if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !_complexExp.test(endValue) && p in style) {
                        ...
                        this._pt = new PropTween1(this._pt, isTransformRelated ? cache : style, p, startNum, relative ? relative * endNum : endNum - startNum, !isTransformRelated && (endUnit === "px" || p === "zIndex") && vars.autoRound !== false ? _renderRoundedCSSProp : _renderCSSProp);
